...
if __name__ == '__main__':
    ...
    train_iter = DataIterator(config.batch_size,
                              data_file=config.base_dir + 'train1.xlsx', use_bert=config.use_bert,
                              tokenizer=tokenizer, seq_length=config.sequence_length)
    dev_iter = DataIterator(config.batch_size, data_file=config.base_dir + 'dev1.xlsx', use_bert=config.use_bert,
